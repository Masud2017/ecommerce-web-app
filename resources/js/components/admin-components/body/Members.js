...
const Members = ()=> {
    ...
    return (
        ...
        <div className = "members-modal-container" id = "modalopen">
                    <div className = "members-modal">
                        <h1>Add new Member</h1>


                        <div className ="members-modal-body">
                            <form className = "members-modal-form">
                                <label className = "members-modal-form-image">
                                    <input type = "file" id = "image" style = {{"margin-bottom":"5px"}} className = "members-modal-file"  />
                                ...
                                <input type = "submit" value = "Create Member" className = "control members-modal-btn" style = {{"border":"none"}} />
                                Or,
                                <input type = "text" placeholder="enter the reciptionist email" className = "control" />
                                <input type = "submit" value = "Create Send auth link to user" className = "control members-modal-btn" style = {{"border":"none"}}/>
            ...
            <div className = "button-center">
                ...
                <button className = "member-button" onClick = {openModal}>Add New Member</button>
